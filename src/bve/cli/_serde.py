...
def target_profile_from_dict(d: dict) -> TargetProfileEnriched:
    return TargetProfileEnriched(
        ...
        long_term_debt_millions=_opt_float(d.get("long_term_debt_millions")),
        market_cap_millions=_opt_float(d.get("market_cap_millions")),
        enterprise_value_millions=_opt_float(d.get("enterprise_value_millions")),
