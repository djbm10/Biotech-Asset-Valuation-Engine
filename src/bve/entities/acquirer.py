...
ACQUIRER_UNIVERSE: list[AcquirerProfile] = [
    ...
    AcquirerProfile(
        ...
        loe_cliffs=[
            LOECliff(product_name="Trulicity (dulaglutide)", indication="type 2 diabetes",
                     peak_sales_millions=5_500, loe_year=2027, revenue_at_risk_millions=3_500,
                     replacement_urgency="high"),
            LOECliff(product_name="Taltz (ixekizumab)", indication="plaque psoriasis/PsA/AS",
                     peak_sales_millions=2_500, loe_year=2029, revenue_at_risk_millions=1_800,
    ...
    AcquirerProfile(
        ...
        preferred_phase="Phase 2",
        loe_cliffs=[
            LOECliff(product_name="Cosentyx (secukinumab)", indication="psoriasis/PsA/AS/nr-axSpA",
                     peak_sales_millions=6_500, loe_year=2028, revenue_at_risk_millions=4_500,
                     replacement_urgency="high"),
            LOECliff(product_name="Entresto (sacubitril/valsartan)", indication="HFrEF/HFpEF",
                     peak_sales_millions=5_000, loe_year=2026, revenue_at_risk_millions=3_500,
    ...
    AcquirerProfile(
        ...
        preferred_phase="Phase 2",
        loe_cliffs=[
            LOECliff(product_name="Perjeta (pertuzumab)", indication="HER2+ breast cancer",
                     peak_sales_millions=4_000, loe_year=2025, revenue_at_risk_millions=2_800,
                     replacement_urgency="high"),
            LOECliff(product_name="Ocrevus (ocrelizumab)", indication="MS",
                     peak_sales_millions=7_500, loe_year=2031, revenue_at_risk_millions=5_000,
    ...
    AcquirerProfile(
        ...
        preferred_phase="Phase 2",
        loe_cliffs=[
            LOECliff(product_name="Prolia/Xgeva (denosumab)", indication="osteoporosis/bone metastasis",
                     peak_sales_millions=4_500, loe_year=2025, revenue_at_risk_millions=3_200,
                     replacement_urgency="critical"),
            LOECliff(product_name="Enbrel (etanercept)", indication="RA/psoriasis (US only)",
                     peak_sales_millions=2_500, loe_year=2029, revenue_at_risk_millions=1_800,
                     replacement_urgency="medium"),
        ],
        deal_capacity=DealCapacity(
