...
- Never commit or push advice files from specific/named people, or any current or future
  meeting prep files, to GitHub. Treat filenames such as `*Advice*`, `*Meeting Prep*`,
  and similar person-specific guidance or preparation notes as private-by-default.
- Before staging, committing, or pushing, inspect the pending file list for private advice
  or meeting prep material and exclude it unless the user explicitly names that exact file
  and confirms it should be published.
